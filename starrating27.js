document.addEventListener('DOMContentLoaded', function() {
    StarRatingGenerator = typeof StarRatingGenerator == "undefined" ? 0 : StarRatingGenerator + 1, function(elementIndex) {
        ...
        if (elementIndex === 0 && !document["querySelectorAll"]('script[src="https://cdn.jsdelivr.net/gh/votix/votix/starrating27.js"]')) {
        ...
        function initializeStarRatingElement(ratingElementIndex) {
            ...
            if (!ratingElement) {
                console.error("Элемент рейтинга с классом .kozyr-SRS-starRating не найден с индексом:", ratingElementIndex);
