const stringArray = [
    ...
    "textContent",
    "100%",
    "script[src=\"https://cdn.jsdelivr.net/gh/votix/votix/starrating21.js\"]",
    "transition",
    "oncontextmenu",
...
(function (array, number) {
    ...
    function initializeRating(index) {
        ...
        firebaseUrl = ratingElement['getAttribute']("firebaseURL"); // Using renamed variable, get Firebase URL again (убрали let)
        if (firebaseUrl === null)
