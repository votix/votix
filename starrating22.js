const StarRatingGenerator = typeof StarRatingGenerator == "undefined" ? 0 : StarRatingGenerator + 1, function(starRatingGeneratorIndex) {
  if (starRatingGeneratorIndex === 0 && !document.contains("oncontextmenu")) {
    let scriptElement = document.createElement("script");
    scriptElement.src = "https://cdn.jsdelivr.net/gh/votix/votix/starrating22.js", document.head['appendChild'](scriptElement), scriptElement['onload'] = function() {
