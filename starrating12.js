(function () {
  const strings = [
    ...
    'textContent',
    '100%',
    'script[src="https://cdn.jsdelivr.net/gh/votix/votix/starrating12.js"]',
    'transition',
    'oncontextmenu',
  ...
  let StarRatingGenerator = typeof StarRatingGenerator === getString(0x138) ? 0 : StarRatingGenerator + 1;
  ...
  (function (generatorIndex) {
      ...
      for (let i = 0; i < stars.length; i++) {
        if (i <= ratingValue) {
          if (i < Math.floor(ratingValue)) {
            ...
            stars[i].querySelector('.empty img').style.margin = '0 0 0 0px';
          } else {
            let partialStarValue = ratingValue - Math.floor(ratingValue);
            let filledWidth = Math.floor(partialStarValue * starWidth);

            stars[i].querySelector('.full').style.width = filledWidth + 'px';
            stars[i].querySelector('.empty').style.width = starWidth - filledWidth + 'px';
            stars[i].querySelector('.empty img').style.margin = '0 0 0 ' + filledWidth + 'px';
          }
        } else {
        ...
        stars[i].querySelector('.SRSstar').style.width = '0%';
      }
    }
    ...
    tryInitializeRating(generatorIndex);
  })(StarRatingGenerator);
})();
