...
document.addEventListener('DOMContentLoaded', function() {
    StarRatingGenerator = typeof StarRatingGenerator == "undefined" ? 0 : StarRatingGenerator + 1, function(elementIndex) {
        ...
        if (elementIndex === 0 && !document["querySelectorAll"]('script[src="https://cdn.jsdelivr.net/gh/votix/votix/starrating29.js"]')) {
        ...
        function initializeStarRatingElement(ratingElementIndex) {
            let ratingElement = document["querySelectorAll"](".kozyr-SRS-average")[ratingElementIndex]; // Находим элемент рейтинга по классу и индексу
