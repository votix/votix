...
function HTMLEncode(){var i=G('txtInput').value,db=G('chkDouble').checked;G('txtInput').value=Encoder.htmlEncode(i,db);}
function HTMLDecode(){var i=G('txtInput').value;G('txtInput').value=Encoder.htmlDecode(i);}
(function(){
