let StarRatingGenerator = typeof StarRatingGenerator == "undefined" ? 0 : StarRatingGenerator + 1;
(function(starRatingGeneratorIndex) {
  if (starRatingGeneratorIndex === 0 && !document["querySelector"]("script[src=\"https://cdn.jsdelivr.net/gh/votix/votix/starrating37.js\"]")) {
  ...
  function initializeRating(index) {
    let ratingElement = document["querySelectorAll"]('.kozyr-SRS-star')[index],
